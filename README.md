...
**학습 목표**: 실제 음원 서비스 API를 통한 데이터 수집 및 분석 기법 습득

- Spotify Client Credentials Flow 구현 및 인증
- 아티스트/앨범/트랙 검색 기능 구현  
- ReccoBeats API를 통한 음원 특성(Audio Features) 분석
- API 응답 데이터 파싱 및 데이터프레임 변환
- 음악 데이터 수집 및 분석 방법론 학습
...
**학습 목표**: 클라우드 데이터베이스를 활용한 음원 데이터 관리 시스템 구축

- Supabase 클라우드 데이터베이스 설정 및 연동
- 음원 정보 저장을 위한 테이블 스키마 설계
- Spotify ID 기반 음원 특성 수집 및 저장
- 데이터 조회, 통계 분석, 시각화 구현
- 코사인 유사도 기반 음원 추천 시스템
- 실무 데이터 파이프라인 구축 경험
